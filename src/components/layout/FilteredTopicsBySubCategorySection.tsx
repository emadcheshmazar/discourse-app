...
interface FilteredTopicsBySubCategorySectionProps {
  className?: string;
  styleMode?: number;
  emptyMessage?: string;
  ...
  return (
    <div className={className}>
      ...
      <HorizontalTopicList
        topics={topics}
        loading={isLoading}
        error={hasError ? categoriesError ?? topicsError : null}
